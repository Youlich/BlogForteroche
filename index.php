...
<section class="portfolio" id="portfolio">
    <section class="container">
        ...
        <br/>
        <h5 class="link text-center"><a href="Blog.php">Voir tous les chapitres</h5>
        <div class="row">
            <div class="col-md-6 col-lg-6">
                <a class="portfolio-item d-block mx-auto">
                    <a href="Blog.php?action=post&amp;id=1" class="chapter"><img class="img-fluid" src="public/images/reve.jpg" alt="">Chapitre 1 : Quand le rêve devient réalité</a>
            </div>
            <div class="col-md-6 col-lg-6">
                <a class="portfolio-item d-block mx-auto">
                    <a href="Blog.php?action=post&amp;id=2" class="chapter"><img class="img-fluid" src="public/images/decouverte.jpg" alt="">Chapitre 2 : découverte de l'Alaska</a>
            </div>
            <div class="col-md-6 col-lg-6">
                <a class="portfolio-item d-block mx-auto">
                    <a href="Blog.php?action=post&amp;id=3" class="chapter"><img class="img-fluid" src="public/images/etudes.jpg" alt="">Chapitre 3 : les études en Alaska</a>
            </div>
            <div class="col-md-6 col-lg-6">
                <a class="portfolio-item d-block mx-auto">
                    <a href="Blog.php?action=post&amp;id=4" class="chapter"><img class="img-fluid" src="public/images/glacier.jpg" alt="">Chapitre 4 : expérience unique</a>
            </div>
        </div>
    </section>
