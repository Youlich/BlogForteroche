...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 21 mars 2018 à 15:49
...
CREATE TABLE IF NOT EXISTS `comments` (
  ...
  `etat` enum('En attente','Validé','Relancé','Refusé','Signalé') NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `comments` (`id`, `comment`, `commentDate`, `chapterId`, `membreId`, `membrePseudo`, `etat`) VALUES
(32, 'J\'adore ce chapitre !', '2018-03-21 09:03:19', 1, 132, 'Youlich', ''),
(33, 'superbe', '2018-03-21 09:03:39', 2, 132, 'Youlich', 'Signalé'),
(34, 'fantastique', '2018-03-21 09:03:53', 3, 132, 'Youlich', 'Validé'),
(35, 'Ouah ! magnifique', '2018-03-21 09:04:05', 4, 132, 'Youlich', 'En attente'),
(36, 'donne envie d\'aller y vivre', '2018-03-21 09:06:20', 3, 132, 'Youlich', 'Signalé'),
(38, 'J\'aime beaucoup ce chapitre !', '2018-03-21 16:38:26', 1, 134, 'Lucas', 'Signalé');
