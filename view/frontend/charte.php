...
<p>Ce site contient un espace membres et un forum.<br/>
...
Cette liste étant non exhaustive, je fais appel à votre bon sens pour discerner ce que vous pouvez publier
et / ou dire.<br/>
...
Le thème de ce blog est restreint. Ce blog est un blog d’auteur
Partout sur le site, vous devrez écrire dans un français correct, toute forme de langage SMS (abrégé) est interdite.<br/>
Vos commentaires seront validés avant d'apparaitre sur mon site et je pourrais être ammené à sanctionner tout membre enfreignant le règlement, ceci allant de l'avertissement
...
interlocuteur(s) puisse(nt), à tout moment, me demander de lire votre échange avec
...
à tout moment demander sa suppression. <br/>
    <br>
    <br>
</p>
